...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Clientes}.
 */
@RestController
@RequestMapping("/api")
public class ClientesResource {
     ...
     */
    @PutMapping("/clientes")
    public ResponseEntity<Clientes> updateClientes(@Valid @RequestBody Clientes clientes) throws URISyntaxException {
