...
describe('Service Tests', () => {
  describe('Clientes Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Clientes(0, 'AAAAAAA', 'AAAAAAA', 0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Clientes', async () => {
      ...
      it('should update a Clientes', async () => {
        const returnedFromService = Object.assign(
          {
            clienteNombre: 'BBBBBB',
            clienteDomicilio: 'BBBBBB',
            clienteCuit: 1,
            clienteID: 1
          },
          elemDefault
      ...
      it('should delete a Clientes', async () => {
